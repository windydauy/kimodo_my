...
#
# Usage:
#   DISTILL_CONFIG=kimodo/distillation/configs/flowmatch_g1_ddim_teacher100_student20_2gpu_10k.yaml \
#   DISTILL_CKPT=outputs/g1_flowmatch_distill_ddim_teacher100_student20_2gpu_10k/ema_final.pt \
#   INFERENCE_STEPS=20 \
...
DISTILL_CONFIG="${DISTILL_CONFIG:-kimodo/distillation/configs/flowmatch_g1_ddim_teacher100_student20_2gpu_10k.yaml}"
DISTILL_CKPT="${DISTILL_CKPT:-outputs/g1_flowmatch_distill_ddim_teacher100_student20_2gpu_10k/ema_final.pt}"
...
echo "[4/6] Generate G1 motion with distilled continuous-flowmatch model ..."
echo "Prompt: ${PROMPT}"
...
PYTHONPATH=. python3 scripts/generate_g1_with_first_heading_flowmatch_continuous.py "${PROMPT}" \
